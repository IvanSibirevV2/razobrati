...
{    
    ...
    public partial class PreProInpDat
    {
        ...
        public static string PlugInputTextData(Boolean TestDataHardFlag, Log ThisLog)
        {
            ThisLog = ThisLog.NewLog("PPID.PITD", "PreProInpDat.PlugInputTextData", true);
            string str = "";
            if (TestDataHardFlag)
            {
                if (false)
        ...
        public static List<List<string>> NaNReduction(List<List<string>> LLS, Log ThisLog)
        {
            ThisLog = ThisLog.NewLog("PPID.NaNR", "PreProInpDat.NaNReduction", true);
        ...
        public static List<List<string>> GetListNaNElements(List<List<string>> LLS, Log ThisLog)
        {
            ThisLog = ThisLog.NewLog("PPID.GLNaNE", "PreProInpDat.GetListNaNElements", true);
