...
namespace QWE_2015_003
{
    public partial class DetermineClustersNumber
    {
        ...
        public static Double WardMethod(List<List<string>> ID_GLNaNE, List<List<string>> ID_PRNaNE, Log ThisLog)
        {
            ...
            {
                List<List<List<string>>> LocalVariable_CCM_v0 = Clustering.Ward.GO_v0(ID_PRNaNE, rez, ThisLog);
                Boolean f_razb = true;
