...
namespace QWE_2015_003
{
    public partial class DCN
    {
        ...
        public static List<List<List<string>>> DetermineClustering_CentroidsMethod_Viper(List<List<string>> ID_GLNaNE, List<List<string>> ID_PRNaNE, string PLog)
        {
            string Log = PLog + ".DCN_DCCM_Viper";//,string PLog
            C.Log.Go(PLog, "DCN_DetermineClustering_CentroidsMethod_Viper");
            ...
            List<List<List<string>>> rezCluster = new List<List<List<string>>>();
            {
                ...
                while (2 < ClusterList.Count())
                {
                    ...
                    string progress = " " + Convert.ToString(ClusterList.Count()) + "/?"; C.Log.Go(PLog, "DetCluCenMet_Viper" + progress);
