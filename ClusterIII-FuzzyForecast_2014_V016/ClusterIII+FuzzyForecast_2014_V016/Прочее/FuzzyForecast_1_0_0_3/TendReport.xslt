	...
	<xsl:template match="/">
		<html>
			...
			<body>
                ...
                <br/>
                График Тенденций<br/>
                <img src="Тенденции Модель.png" alt="Тенденции модель"></img>
                <br/>
                График интенсивностей<br/>
                <img src="Интенсивности Модель.png" alt="Интенсивности Модель"></img>
                <br/>
				...
				<xsl:for-each select="$XML">
					...
					<br/>
					Таблица правил для Типов Тенденций<br/>
					<table border="1">
						<thead>
							<tr>
								<th>
					...
					<br/>
					Таблица правил для Интенвивностей Тенденций<br/>
					<table border="1">
						<thead>
							<tr>
								<th>
					...
					<table border="1">
						...
						<tbody>
							<xsl:for-each select="ReportOfCrispResultRowFuzzyResultRow">
								<xsl:for-each select="RuleMFTTend">
