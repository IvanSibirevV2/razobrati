	...
	<xsl:template match="/">
		<html>
			...
			<body>
                ...
                <br/>
                Графики ACL-шкалы для заданного временного ряда<br/>
                <img src="Основная шкала.png" alt="Базовая шкала"></img>
                <br/>
                <img src="Типы Тенденций.png" alt="Тенденции"></img>
                <br/>
                <img src="Интенсивность.png" alt="Интенсивность"></img>
                <br/>
				...
				<xsl:for-each select="$XML">
					...
					<table border="1">
						...
						<tbody>
							<xsl:for-each select="ReportOfCrispNResultRowFuzzyNResultRow">
